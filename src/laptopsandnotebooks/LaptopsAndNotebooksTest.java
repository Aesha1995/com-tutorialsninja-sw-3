...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyProductsPriceDisplayHighToLowSuccessfully() {
        ...
        compareElements(afterSelectionList1.toString(),beforeSelectionList1.toString());
...
//        Select select = new Select(dropDown);
//        select.selectByVisibleText("Price (High > Low)");
        selectDropDownElements(By.xpath("//select[@id='input-sort']"),"Price (High > Low)");
        //2.4
        ...
        compareElements(actualTextMacBook1,exceptedTextMacBook);
        ...
        compareElements(expectedCart,actualCart1);
        ...
        compareElements(expectedName,actualName1);
        ...
        compareElements(expectedCheckout,actualCheckout1);
        ...
        compareElements(expectedCustomer,actualCustomer1);
...
//        select1.selectByVisibleText("United Kingdom");
        selectDropDownElements(By.xpath("//select[@id='input-payment-country']"),"United Kingdom");
...
//        select2.selectByVisibleText("Greater London");
        ...
        selectDropDownElements(By.xpath("//select[@id='input-payment-zone']"),"Greater London");
