...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder()throws InterruptedException {
        ...
        selectDropDownElements(By.xpath("//select[@id='input-sort']"),"Name (Z - A)");
...
//2.3 and 2.4
        selectDropDownElements(By.xpath("//select[@id='input-sort']"), "Name (A - Z)");
        ...
        compareElements(actualText, expectedText1);
...
//2.9
            ...
            compareElements(expectedMessage, actualMessage1);
...
//2.11
            ...
            compareElements(expectedShopping, actualShopping1);
//2.12
            ...
            compareElements(expectedProductName, actualProductName1);
...
//2.14
            ...
            compareElements(expectedModel, actualModel1);
...
//2.15
            ...
            compareElements(expectedTotal, actualTotal1);
        }
        @After
